...
const LoginSignupModal = ({ setShowSignUpModal, onClose, signUpModalRef }) => {
  ...
  const handleInfoSubmit = () => {
    ...
    window.history.pushState(null, "", "/preference");
  };
  ...
  const handlePreferenceSubmit = () => {
    ...
    setShowPreferenceModal(false);
    onClose(); // Close the overall modal
  ...
  return (
    <div style={overlayStyle}>
      ...
      {!showOTPModal && !showInfoModal && !showPreferenceModal && (
            ...
            <div style={formContainerStyle}>
              <form style={formStyle}>
                ...
                <div style={timerContainerStyle}>
                  {timer > 0 ? (
                    <span>You will receive OTP within {timer} seconds. </span>
                  ) : (
                    ""
                  )}
                  {timer === 0 && (
                ...
                <div style={preferenceContainerStyle}>
                  <div style={checkboxContainerStyle}>
                    <input
                      ...
                      onChange={(event) =>
                        setPurchaseProperty(event.target.checked)
                      }
                      id="purchaseProperty"
                      style={checkboxStyle}
                    />
                    <label
                      htmlFor="purchaseProperty"
                      style={{ ...checkboxLabelStyle, color: "#2E48DE" }}
                    >
                  ...
                  <div style={checkboxContainerStyle}>
                    <input
                      ...
                      onChange={(event) =>
                        setSellProperty(event.target.checked)
                      }
                      id="sellProperty"
                      style={checkboxStyle}
                    />
                    <label
                      htmlFor="sellProperty"
                      style={{ ...checkboxLabelStyle, color: "#2e48de" }}
                    >
                  ...
                  <div style={checkboxContainerStyle}>
                    <input
                      ...
                      onChange={(event) =>
                        setRentProperty(event.target.checked)
                      }
                      id="rentProperty"
                      style={checkboxStyle}
                    />
                  ...
                  <div style={checkboxContainerStyle}>
                    <input
                      ...
                      onChange={(event) =>
                        setSellPropertyProject(event.target.checked)
                      }
                      id="sellPropertyProject"
                      style={checkboxStyle}
                    />
                    <label
                      htmlFor="sellPropertyProject"
                      style={{ ...checkboxLabelStyle, color: "#2e48de" }}
                    >
                      Want to sell your property project
                    </label>
                  </div>
                </div>
                <button
