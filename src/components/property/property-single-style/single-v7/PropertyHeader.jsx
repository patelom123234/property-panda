    ...
    <>
      <div className="col-lg-8">
        <p className="text-white">
          home / buy / residential / Apartment Type / Coral 43
        </p>
        <div className="single-property-content mb30-md">
          ...
          <div className="property-meta d-flex align-items-center">
            <a className="ff-heading text-thm fz15 pr10 bdrrn-sm" href="#">
              <i className="fas fa-check fz10 pe-2" />
              RERA Registerd | Registration No: PR/GJ/GANDHINAGAR/
              GANDHINAGAR/AUDA/MAA07612/A1M/110122
            </a>
            {/* <a
