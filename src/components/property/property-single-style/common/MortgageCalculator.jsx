  ...
  return (
    <>
      <div className="col-md-12">
        ...
        <p>A simple tool for understanding and managing your monthly 
payments. Gain financial clarity and make informed 
decisions on your loans </p>
        {/* End chart */}
        ...
        <form className="comments_form mt30">
          <div className="row">
            <div className="col-md-12">
              <div className="mb-4">
                <label className="fw600 ff-heading mb-2">Total Loan Amount</label>
                <input
                  type="text"
