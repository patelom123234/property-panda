  ...
  return (
    <>
      {reviews.map((review, index) => (
        <div className="col-md-12" key={index} style={{boxShadow: '0px 8px 8px -3px rgba(0, 0, 0, 0.25)',padding: '20px 10px 0px 10px', borderRadius:'10px'}}>
          ...
          <div className="review_cansel_btns d-flex bdrb1 pb5">
            <a href="#">
